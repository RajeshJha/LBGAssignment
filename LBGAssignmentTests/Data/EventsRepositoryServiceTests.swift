...
final class EventsRepositoryServiceTests: XCTestCase {
    func testForDummyDataresponse() throws {
        ...
        let eventRepo = EventsRepositoryMockService(dataTransferService: dts)
        var eventList : [Event] = []
...
private class EventsRepositoryMockService : EventsRepository {
